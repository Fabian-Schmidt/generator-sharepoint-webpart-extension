...
module.exports = yeoman.Base.extend({
  ...
  writing: function () {
    ...
    this.fs.copyTpl(this.templatePath('typings.json'), this.destinationPath('typings.json'), this.props);
    ...
    this.fs.copyTpl(this.templatePath('src/js/index.tsx'), this.destinationPath('src/js/index.tsx'), this.props);
    this.fs.copyTpl(this.templatePath('src/js/components/Counter.tsx'), this.destinationPath('src/js/components/Counter.tsx'), this.props);
  },
